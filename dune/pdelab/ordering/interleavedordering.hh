...
namespace Dune {
  namespace PDELab {
    ...
    public:
       ...
       *       the leaf of the tree.
       */
      CompositeInterleavedOrdering(bool backend_blocked, const InterleavedOrderingTag& ordering_tag, typename Base::GFSData* gfs_data, Dune::shared_ptr<Children>... children)
        : Node(children...)
