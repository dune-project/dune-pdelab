...
namespace Dune {
  namespace PDELab {
    ...
    struct LocalAssemblerCallSwitch
    {
      ...
      //******************************************************************
      // these jacobian_apply()-methods are there to not brake existing
      // matrix-free code for linear problems
      //******************************************************************
      template<typename EG, typename LFSU, typename X, typename LFSV, typename Y>
    ...
    struct LocalAssemblerCallSwitch<LA,true,true>
    {
      ...
      //******************************************************************
      // jacobian_apply methods for linear local operators
      //******************************************************************
      template<typename EG, typename LFSU, typename X, typename LFSV, typename Y>
      static void jacobian_apply_volume (const LA& la, const EG& eg, const LFSU& lfsu, const X& x, const X& z, const LFSV& lfsv, Y& y)
      {
        // drop the linearization point here
      ...
      //******************************************************************
      // these jacobian_apply()-methods are there not to brake existing
      // matrix-free code for linear problems
      //******************************************************************
      template<typename EG, typename LFSU, typename X, typename LFSV, typename Y>
      static void jacobian_apply_volume (const LA& la, const EG& eg, const LFSU& lfsu, const X& x, const LFSV& lfsv, Y& y)
    ...
    struct LocalAssemblerCallSwitch<LA,true,false>
    {
      ...
      //******************************************************************
      // jacobian_apply methds for nonlinear local operators
      //******************************************************************
      template<typename EG, typename LFSU, typename X, typename LFSV, typename Y>
      static void jacobian_apply_volume (const LA& la, const EG& eg, const LFSU& lfsu, const X& x, const X& z, const LFSV& lfsv, Y& y)
      {
