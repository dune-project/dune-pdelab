    ...
    namespace Blockstructured {
      ...
      public:
        ...
        void assemble(LocalAssemblerEngine &assembler_engine) const {
          using LFSUCache = Dune::PDELab::Blockstructured::LFSIndexCache<LFSU, CU>;
          using LFSVCache = Dune::PDELab::Blockstructured::LFSIndexCache<LFSV, CV>;
          ...
          // Traverse grid view
          for (const auto &element : Dune::elements(entity_set)) {
            // Compute unique id
            ...
            if (require_uv_skeleton || require_v_skeleton ||
              ...
              for (const auto &intersection : Dune::intersections(entity_set, element)) {

                Dune::PDELab::IntersectionGeometry<Intersection> ig(intersection, intersection_index);

                auto intersection_data = Dune::PDELab::classifyIntersection(entity_set, intersection);
