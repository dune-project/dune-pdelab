...
#ifndef DUNE_PDELAB_GRIDOPERATOR_ONESTEP_NONLINEARJACOBIANAPPLYENGINE_HH
#define DUNE_PDELAB_GRIDOPERATOR_ONESTEP_NONLINEARJACOBIANAPPLYENGINE_HH
...
namespace Dune{
  namespace PDELab{
    ...
    */
    ...
    class OneStepLocalNonlinearJacobianApplyAssemblerEngine
      : public OneStepLocalAssemblerEngineBase<OSLA,
                                               typename OSLA::LocalAssemblerDT0::LocalNonlinearJacobianApplyAssemblerEngine,
                                               typename OSLA::LocalAssemblerDT1::LocalNonlinearJacobianApplyAssemblerEngine
                                               >
    {
    ...
    public:
      ...
      typedef typename LocalAssemblerDT0::LocalNonlinearJacobianApplyAssemblerEngine JacobianEngineDT0;
      typedef typename LocalAssemblerDT1::LocalNonlinearJacobianApplyAssemblerEngine JacobianEngineDT1;
      ...
      */
      OneStepLocalNonlinearJacobianApplyAssemblerEngine(LocalAssembler& local_assembler_)
        ...
        , invalid_update(static_cast<Solution*>(0))
        , residual(invalid_residual), solution(invalid_solution), update(invalid_update)
      {}
    ...
    }; // end class OneStepLocalNonlinearJacobianApplyAssemblerEngine
