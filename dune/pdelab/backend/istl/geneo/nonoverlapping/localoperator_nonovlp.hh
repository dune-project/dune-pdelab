#ifndef DUNE_PDELAB_BACKEND_ISTL_GENEO_NEW_LOCALOPERATOR_NONOVLP_HH
#define DUNE_PDELAB_BACKEND_ISTL_GENEO_NEW_LOCALOPERATOR_NONOVLP_HH
...
namespace Dune {
  namespace PDELab {
     ...
     */
    template<typename LocalOperatorBase>
    class NewLocalOperatorNoGhost {

    public:
      NewLocalOperatorNoGhost (LocalOperatorBase& base_)
       : baseop(base_) {
      }
      ...
      enum { doLambdaVolumePostSkeleton = LocalOperatorBase::doLambdaVolumePostSkeleton };
    ...
    private:
      ...
      bool entity_is_ghost (const Entity& entity) const {
        return entity.entity().partitionType() == Dune::PartitionType::GhostEntity;
      }
      template <typename Entity>
      bool intersection_is_ghost (const Entity& entity) const {
        return entity.inside().partitionType() == Dune::PartitionType::GhostEntity;
      }
