...
#ifndef DUNE_COMMON_PARALLEL_VARIABLESIZECOMMUNICATOR_WITH_RANK_HH // Still fits the line!
#define DUNE_COMMON_PARALLEL_VARIABLESIZECOMMUNICATOR_WITH_RANK_HH
