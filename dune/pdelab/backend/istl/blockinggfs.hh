...
#ifndef DUNE_PDELAB_BACKEND_COMMON_BLOCKINGGFS_HH
#define DUNE_PDELAB_BACKEND_COMMON_BLOCKINGGFS_HH
  ...
  namespace PDELab {
    ...
    namespace ISTL {
      ...
      struct cascading_vector_descriptor
      {
        ...
        static const bool support_no_blocking =
          (Sibling::support_no_blocking &&
           std::is_same<
            typename Sibling::blocking,
            typename Child::blocking
           >::value);
      ...
      struct parent_child_vector_descriptor_data
      {
        ...
        typedef typename Child::blocking child_blocking;
        ...
        : public Data
      {
        ...
        typedef typename Data::child_blocking blocking;
      };
...
#endif // DUNE_PDELAB_BACKEND_COMMON_BLOCKINGGFS_HH
