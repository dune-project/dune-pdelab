...
int main(int argc, char** argv)
{
  try{
...

    {
      ...
      // solve problem
      bool good = poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"coloredtbbgridoperator_yasp_Q1_2d",2);
...

    {
      ...
      // solve problem
      bool good = poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"coloredtbbgridoperator_yasp_Q2_2d",2);
      accumulate_result(result, good);
    }

    {
      ...
      // solve problem
      bool good = poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"coloredtbbgridoperator_yasp_Q1_3d",2);
      accumulate_result(result, good);
    }

    {
      ...
      // solve problem
      bool good = poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"coloredtbbgridoperator_yasp_Q2_3d",2);
      accumulate_result(result, good);
    }
