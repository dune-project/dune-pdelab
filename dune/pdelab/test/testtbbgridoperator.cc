...
int main(int argc, char** argv)
{
  try{
...

    {
      ...
      // solve problem
      poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"tbbgridoperator_yasp_Q1_2d",2);
      pass(result);
    }

    {
      ...
      // solve problem
      poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"tbbgridoperator_yasp_Q2_2d",2);
      pass(result);
    }

    {
      ...
      // solve problem
      poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"tbbgridoperator_yasp_Q1_3d",2);
      pass(result);
    }

    {
      ...
      // solve problem
      poisson<GV,FEM,Dune::PDELab::ConformingDirichletConstraints>(gv,fem,"tbbgridoperator_yasp_Q2_3d",2);
      pass(result);
    }
