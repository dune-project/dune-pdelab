...
double interpolationerror (const GV& gv, const FEM &fem, const std::string &name = "")
{
  ...
  typedef Dune::PDELab::DiscreteGridFunction<GFS, X> IFunc;
  IFunc v(gfs,x);
