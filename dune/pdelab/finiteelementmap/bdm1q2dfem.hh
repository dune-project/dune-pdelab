...
#ifndef DUNE_PDELAB_BDM1Q2DFEM_HH
#define DUNE_PDELAB_BDM1Q2DFEM_HH
...
namespace Dune {
  namespace PDELab {
    ...
    class BDM1Q2DLocalFiniteElementMap :
      public LocalFiniteElementMapInterface<
        LocalFiniteElementMapTraits<Dune::BDM1Q2DLocalFiniteElement<D,R> >,
        BDM1Q2DLocalFiniteElementMap<GV,D,R> >
    {
      typedef Dune::BDM1Q2DLocalFiniteElement<D,R> FE;
    ...
    public:
      ...
      BDM1Q2DLocalFiniteElementMap(const GV& gv_)
...
#endif // DUNE_PDELAB_BDM1Q2DFEM_HH
