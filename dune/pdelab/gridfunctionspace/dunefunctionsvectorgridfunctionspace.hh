...
#ifndef DUNE_PDELAB_GRIDFUNCTIONSPACE_DUNEFUNCTIONSVECTORGRIDFUNCTIONSPACE_HH
#define DUNE_PDELAB_GRIDFUNCTIONSPACE_DUNEFUNCTIONSVECTORGRIDFUNCTIONSPACE_HH
...
namespace Dune {
  namespace PDELab {
    ...
    /** \brief base class for tuples of grid function spaces
        ...
        \tparam DFBasis The underlying dune-functions function space basis
    ...
    */
    ...
    class DuneFunctionsVectorGridFunctionSpace
      : public TypeTree::PowerNode<GridFunctionSpace<
                                     impl::EntitySet<typename DFBasis::GridView>,
                                     DuneFunctionsFiniteElementMap<DFBasis>,
                                     Constraints,
                                     LeafBackend,
                                     LeafOrderingTag
                                     >,
                                   k>
      , public PowerCompositeGridFunctionSpaceBase<DuneFunctionsVectorGridFunctionSpace<
                                                     DFBasis,
                                                     k,
                                                     Backend,
                                                     LeafBackend,
      ...
      , public DataHandleProvider<DuneFunctionsVectorGridFunctionSpace<
                                    DFBasis,
                                    k,
                                    Backend,
                                    LeafBackend,
    ...
    public:
      ...
      typedef PowerCompositeGridFunctionSpaceBase<
        DuneFunctionsVectorGridFunctionSpace,
        impl::EntitySet<GV>,
        Backend,
        OrderingTag,
      ...
      typedef TypeTree::TransformTree<DuneFunctionsVectorGridFunctionSpace,
                                      gfs_to_ordering<DuneFunctionsVectorGridFunctionSpace>
    ...
    public:
      ...
      DuneFunctionsVectorGridFunctionSpace(const DFBasis& dfBasis,
        ...
        : BaseT(create_components(typename Traits::EntitySet(dfBasis.gridView()),
                                  std::make_shared<FEM>(dfBasis),
                                  leaf_backend,
                                  leaf_ordering_tag))
...
#endif // DUNE_PDELAB_GRIDFUNCTIONSPACE_DUNEFUNCTIONSVECTORGRIDFUNCTIONSPACE_HH
