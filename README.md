...
This is version 2.6.0-rc1 of the PDELab library.
...
* DUNE core libraries (dune-common, dune-geometry, dune-grid, dune-istl,
  dune-localfunctions) version 2.6.0, and their respective dependencies.

* The dune-typetree library, version 2.6.0. You can obtain a [source package][0] or
